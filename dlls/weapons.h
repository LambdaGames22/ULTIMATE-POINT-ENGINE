...
public:
	...
	static CGrenade *ShootSatchelTimed( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time ); // Step4enko
	...
	void EXPORT BounceSatchelTouch( CBaseEntity *pOther ); // Step4enko
...
#define	WEAPON_DEAGLE			16 // Step4enko
...
public:
	...
	BOOL Deploy( void );
	void Holster( int skiplocal = 0 ); // Step4enko
	void Reload( void );
	void WeaponIdle( void );

	int AddToPlayer( CBasePlayer *pPlayer ); // Step4enko

	BOOL m_fInFirstDraw; // Step4enko

	int m_iSpriteTexture; // Step4enko

	void EXPORT DropClip( void );
...
public:
	...
	int GetItemInfo(ItemInfo *p);
	void WeaponIdle( void );
	//int AddToPlayer( CBasePlayer *pPlayer ); // Step4enko: UNDONE
...
public:
	...
	int m_iShell; // Step4enko
	float m_flSoundDelay; // Step4enko
...
public:
	...
	int m_iGlowEgon; // Step4enko
	int m_iGlowEgon2; // Step4enko
	int m_iGlowWall; // Jonny
	int m_iGlowWhite; // Jonny
	int m_iMuzEgon; // Step4enko
...
public:
	...
	bool AddDuplicate( CBasePlayerWeapon* pOriginal );
	int AddToPlayer( CBasePlayer *pPlayer );
