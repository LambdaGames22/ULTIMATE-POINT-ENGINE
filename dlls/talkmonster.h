...
public:
	...
	// Step4enko: Fixed fOkToSpeak code. Uses 0 instead of O.
	BOOL F0kToSpeak( void );
	...
	int			m_iszDecline;					// Custom +USE sentence group (refuse to follow)
	int			m_iszSpeakAs;					// Change the prefix for all this monster's speeches
