...
Task_t	tlFollowScared[] =
{
	...
	{ TASK_SET_SCHEDULE,		(float)SCHED_TARGET_FACE_SCARED }, // WAS CUT
};
...
void CScientist :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	case SCIENTIST_AE_HEAL:		// Heal my target (if within range)
		Heal(); // Step4enko: UNDONE - Heal sound?
		break;
...
void CScientist :: PainSound ( void )
{
	...
	case 5: EMIT_SOUND_DYN( ENT(pev), CHAN_VOICE, "scientist/sci_pain6.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	case 6: EMIT_SOUND_DYN( ENT(pev), CHAN_VOICE, "scientist/sci_pain7.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	case 7: EMIT_SOUND_DYN( ENT(pev), CHAN_VOICE, "scientist/sci_pain8.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	case 8: EMIT_SOUND_DYN( ENT(pev), CHAN_VOICE, "scientist/sci_pain9.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	case 9: EMIT_SOUND_DYN( ENT(pev), CHAN_VOICE, "scientist/sci_pain10.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	}
}
...
void CScientist :: DeathSound ( void )
{
	...
	{
	    case 0: EMIT_SOUND_DYN( ENT(pev), CHAN_VOICE, "scientist/scream21.wav", 1, ATTN_NORM, 0, GetVoicePitch()); break;
	    case 1: PainSound(); break;
	}
}
...
Schedule_t *CScientist :: GetSchedule ( void )
{
	...
	if ( HasConditions( bits_COND_HEAR_SOUND ) )
	{
		...
		{
			// Step4enko
			PlaySentence( "SC_GRENADE", 4, VOL_NORM, ATTN_NORM );
