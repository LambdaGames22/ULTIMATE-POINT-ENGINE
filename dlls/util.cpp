...
BOOL NeedUpdate( CBaseEntity *pEnt ); // Synchronization may be lost (e.g. after changelevel) merge it.
...
//		ApplyDesiredSettings( pEnt ); // Step4enko: fuck this.
		return;
	}
...
// Step4enko: My Dlight System
void UTIL_TrueExplosionDlight ( entvars_t *pev )
{
#ifndef CLIENT_DLL
