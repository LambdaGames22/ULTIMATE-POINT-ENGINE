...
void CHandGrenade::WeaponIdle( void )
{
	...
	if ( m_flStartThrow )
	{
		...
		EjectBrass ( pev->origin + gpGlobals->v_up * RANDOM_LONG(20,26) + gpGlobals->v_forward * RANDOM_LONG(18,22), vecShellVelocity, pev->angles.y, m_iGrenadeSpoon, TE_BOUNCE_SHELL);
		EjectBrass ( pev->origin + gpGlobals->v_up * RANDOM_LONG(20,29) + gpGlobals->v_forward * RANDOM_LONG(15,27), vecShellVelocity, pev->angles.y, m_iGrenadePin, TE_BOUNCE_SHELL);
