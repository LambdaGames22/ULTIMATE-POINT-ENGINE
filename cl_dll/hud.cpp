...
cvar_t *cl_rollspeed; // Step4enko
cvar_t *cl_rollangle; // Step4enko
...
void CHud :: Init( void )
{
	...
	HOOK_MESSAGE( Impact ); // Step4enko
	HOOK_MESSAGE( WaterSplash ); // Step4enko

	cl_rollangle = gEngfuncs.pfnRegisterVariable ( "cl_rollangle", "0.65", FCVAR_CLIENTDLL|FCVAR_ARCHIVE ); // Step4enko
    cl_rollspeed = gEngfuncs.pfnRegisterVariable ( "cl_rollspeed", "300", FCVAR_CLIENTDLL|FCVAR_ARCHIVE ); // Step4enko
