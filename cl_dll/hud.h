...
#define RGB_YELLOWISH 0x001E90FF //255,160,0 // Step4enko
...
public:
	...
	int _cdecl MsgFunc_Impact( const char *pszName, int iSize, void *pbuf ); // Step4enko
    int _cdecl MsgFunc_WaterSplash( const char *pszName, int iSize, void *pbuf ); // Step4enko
